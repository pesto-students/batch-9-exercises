...
describe('binaryAgent', () => {
  ...
  test('throw error if input string is not binary characters', () => {
    expect(() => {binaryAgent('0010abc truefalse 1234321 null null null undefined false 0110101011')}).toThrow();
  });
});
